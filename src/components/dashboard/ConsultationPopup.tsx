...
import { getConsultationAvailableDates, createConsultationBooking, getWallet, useThemeStore } from "../../storeApi/storeApi";
...
const ConsultationPopup = ({ consultation, onClose }: ConsultationPopupProps) => {
  ...
  return (
    ...
    >
      <div className={`relative rounded-xl w-[90%] max-w-5xl h-[90vh] p-6 overflow-y-auto shadow-2xl transition-colors duration-300 ${
